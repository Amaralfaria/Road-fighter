...
LOOP:		
		...
		li a2,32		#a2 = coluna
		call ENDERECO		#retorna endereço da linha de baixo
		...
		li a2,32		#a2 = coluna
		call ENDERECO		#retorna endereço da linha de baixo no frame 1
		...
		li a2,32		#a2 = coluna
		call ENDERECO		#retorna endereço da linha de cima no frame 1
...
PRIMEIRA_LINHA:
		...
		mv a1,t0
		li a2,32		#a2 = coluna
		call ENDERECO		#retorna o endereço da primeira linha do frame 0
		mv a3,a0		#guarda o endereço em a3
		
		li a0,0
		mv a1,s5
		li a2,32		#a2 = coluna
		call ENDERECO		#retorna o endereço da primeria linha no frame 1
...
TOCA_PISTA:
		...
		beq t0,t1, ZERA_CONTADOR_PISTA		# contador chegou no final? então  vá para FIM
		li t2,8
		mul t2,t0,t2
